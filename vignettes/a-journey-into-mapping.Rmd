...
```{r}
mappingIT(data = it, var = "ripartizione", typeStatic = "typo")
mappingIT(data = it, var = c("maschi", "femmine"), typeStatic = "typo")
mappingIT(data = it, var = c("maschi", "femmine"), typeStatic = "typo", mapping.options(palette.cont = c("Greens", "Blues")))
```
...
```{r}
mappingIT(data = it, var = "totale", typeStatic = "bar")
```
